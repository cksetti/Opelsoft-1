...
const VALUES = [
  { tint: '#4F46E5', title: 'Access to Qualified and Engaged Professionals', body: 'We have curated a robust, global network of qualified talent spanning technology, engineering, healthcare, and professional services. Our proprietary applicant tracking system helps our recruiters find your ideal candidate with speed and accuracy. We continually invest in our talent pipeline by certifying, upskilling, and retraining our consultants.', icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" /></> },
  { tint: '#7C3AED', title: 'Thorough Vetting and Recruiting Process', body: 'We manage the entire recruiting process — from strategic goal setting, candidate screening, interviewing, and skills validation testing, to recommending candidates, conveying offers, onboarding, and performance management — so you can focus on what’s important: running and growing your business.', icon: <><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></> },
  { tint: '#10B981', title: 'Commitment to Compliance', body: 'Our compliance team understands the importance of meeting and adapting to precise contractual screening requirements through background, financial, and substance screening. Clients trust us to ensure documents are signed, information is properly handled, and the details get the attention they deserve — held to the highest standards of data security for our contractors and clients.', icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /> },
];
